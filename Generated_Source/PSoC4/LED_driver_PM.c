...
#if(!LED_driver_CHECK_DEEPSLEEP_SUPPORT)
    static LED_driver_BACKUP_STRUCT LED_driver_backup =
    {
        0u, /* enableState */
    };
#endif /* (LED_driver_CHECK_DEEPSLEEP_SUPPORT) */


/*******************************************************************************
* Function Name: LED_driver_SaveConfig
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: LED_driver_RestoreConfig
********************************************************************************
*
* Summary:
*  Empty function. Included for consistency with other components.
...
*
* Global variables:
*  LED_driver_backup: The structure field 'enableState' is modified
...
{
#if(!LED_driver_CHECK_DEEPSLEEP_SUPPORT)
    if(LED_driver_CHECK_PWR_MODE_OFF)
    {
        LED_driver_backup.enableState = 1u;
        LED_driver_Stop();
    }
    else /* The component is disabled */
    {
        LED_driver_backup.enableState = 0u;
    }
#endif /* (LED_driver_CHECK_DEEPSLEEP_SUPPORT) */
}
...
*
* Global variables:
*  LED_driver_backup: The structure field 'enableState' is used to
